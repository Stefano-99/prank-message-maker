...
import { ArrowLeft, Phone, Video, Info, Heart, Image, Mic, Send } from "lucide-react";
...
export default function InstagramSimulator({
  ...
  return (
    <div className="w-full max-w-[375px] h-[700px] mx-auto rounded-[2rem] overflow-hidden border-[3px] border-muted bg-ig-bg flex flex-col shadow-2xl shadow-accent/10">
      {/* Status bar */}
